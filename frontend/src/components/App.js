    ...
    <div className="App">
      ...
      {Boards.map((board, index) => 
        ...
        onDrop={(e) => dropCardHandler(e,board)}>
          ...
          <div id={board.id} className="list__input"><input type="text" autocomplete="off" className={board.id} name="newList" value={inputItem} onChange={(event) => setInputItem(event.target.value)} id="newList" placeholder="list name"/>
      ...
      <div class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" autocomplete="off" name="newList" value={inputOne} onChange={(event) => setInputOne(event.target.value)} id="newList"/>
            </div>
